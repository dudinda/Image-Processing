...
<p align="center">
    ...
    <p align="center">Fig. 1 - The main view and transient/signleton views as tabs. The opened rgb tab is a transient view. The settings tab is a singleton view. The frame is taken from <a src="https://i.imgur.com/h57F8D7.jpg">Thomas the Tank Engine"</a> series and processed with the Grayscale->Inversion->Laplacian Operator 5x5->Inversion->Shear Rotation 20°->Bicubic Interpolation (0.2, 0.2)->Cyclic Translation (33, 33) (hold) algorithm chain.</p>
</p>
<br/><br/>
